...
class Github {
   ...
   * @param {Context} context A webhook context
   */
  ...
  sendRequest(url, body, options) {
    ...
    return request(requestOptions, resultCallback);
  }
   ...
   */
  applyLabels(context, labels) {
    return this.sendRequest(context.getLabelUrl(), labels);
  }
  ...
  addComment(context, comment) {
    return this.sendRequest(context.getCommentUrl(), comment);
  }
   ...
   */
  postStatus(context, state, targetUrl, description, statusContext) {
    return this.sendRequest(context.getStatusUrl(), {
      state,
